...
while (<DATA>) {
    ...
    ok( defined $bObj->transcript());
    
    #Make sure the transcript is defined 
    ok( defined $bObj->isoform());
    ...
    #Make sure the transcript is defined 
    ok( defined $bObj->prot());
    
    #Make sure the transcript is defined 
    ok( defined $bObj->pident());
    
    #Make sure the transcript is defined 
    ok( defined $bObj->length());
    
    #Make sure the transcript is defined 
    ok( defined $bObj->mismatch());
    
    #Make sure the transcript is defined 
    ok( defined $bObj->gapopen());
}
